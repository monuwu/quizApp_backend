  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (loginResult.success) {
        ...
        setLocalError(loginResult.message);
      }
    } catch (err: any) {
      ...
      <div className="w-full max-w-[448px] bg-white/95 border border-slate-200 rounded-3xl shadow-xl backdrop-blur-md px-6 py-10 sm:px-10">
        ...
        <form onSubmit={handleSubmit} className="mt-10 space-y-5">
          ...
          <button
            ...
            className="w-full h-[60px] flex items-center justify-center gap-2 bg-[#0045DD] text-white rounded-xl shadow-[0_0_40px_-8px_rgba(0,69,221,0.4)] text-lg font-semibold hover:bg-[#003bb8] active:scale-[0.98] transition-all disabled:opacity-70 disabled:cursor-not-allowed"
          >
